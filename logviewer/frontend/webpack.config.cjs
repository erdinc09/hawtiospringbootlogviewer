    ...
    devServer: {
      ...
      setupMiddlewares: (middlewares, devServer) => {
        ...
        if (publicPath && publicPath !== "/") {
          ...
          devServer.app.get(`${publicPath}$`, (_, res) =>
        ...
        */
        ...
        devServer.app.get(
          `${publicPath}/auth/config/session-timeout`,
          (_, res) => {
            res.type("application/json");
            res.send("{}");
          }
        ...
        devServer.app.get(
          `${publicPath}/keycloak/validate-subject-matches`,
          (_, res) => res.send("true")
        );
